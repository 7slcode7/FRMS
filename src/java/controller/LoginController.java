        ...
        if(lg.lgValidator(uName, pass)){
            ...
            if (LoginValidator.userAccountType.equals("CJMO")){
                ...
                response.sendRedirect("admin/index.jsp");
                 ...
                 response.sendRedirect("AJMO/index.html");
            }
            
             else if( LoginValidator.userAccountType.equals("HPLO")){
//                 request.getRequestDispatcher("PoliceOfficer/index.html").forward(request, response);
                response.sendRedirect("PoliceOfficer/index.html");
            }
            else if( LoginValidator.userAccountType.equals("RGR")){
//                 request.getRequestDispatcher("PoliceOfficer/index.html").forward(request, response);
                response.sendRedirect("Registrar/index.html");
            }
